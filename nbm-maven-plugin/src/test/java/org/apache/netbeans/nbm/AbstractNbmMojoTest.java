...
public class AbstractNbmMojoTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        treeRoot = createNode(
                ...
                new HashMap<Artifact, ExamineManifest>());
    }
    ...
    public void testGetLibraryArtifacts1() throws Exception {
        ...
        DependencyNode module =
                createNode(treeRoot, "gr1", "ar1", "1.0", "jar", "compile", true, runtimes, examinerCache);
    ...
    public void testGetLibraryArtifact2() throws Exception {
        ...
        DependencyNode library =
                createNode(treeRoot, "gr1", "ar1", "1.0", "jar", "compile", false, runtimes, examinerCache);
    ...
    public void testGetLibraryArtifact3() throws Exception {
        ...
        DependencyNode library =
                createNode(treeRoot, "gr1", "ar1", "1.0", "jar", "compile", false, runtimes, examinerCache);
        treeRoot.setChildren(Collections.singletonList(library));
        DependencyNode translibrary =
                createNode(library, "gr2", "ar2", "1.0", "jar", "runtime", false, runtimes, examinerCache);
    ...
    public void testGetLibraryArtifact4() throws Exception {
        ...
        treeRoot.setChildren(Collections.singletonList(module));
        DependencyNode translibrary =
                createNode(module, "gr2", "ar2", "1.0", "jar", "runtime", false, runtimes, examinerCache);
    ...
    public void testGetLibraryArtifact5() throws Exception {
        ...
        DependencyNode library =
                createNode(treeRoot, "gr3", "ar3", "1.0", "jar", "compile", false, runtimes, examinerCache);
        DependencyNode translibrary2 =
                createNode(library, "gr4", "ar4", "1.0", "jar", "runtime", false, runtimes, examinerCache);
    ...
    private DefaultDependencyNode createNode(
            ...
            String scope,
            boolean isModule,
            List<Artifact> runtimes,
            Map<Artifact, ExamineManifest> cache) {
