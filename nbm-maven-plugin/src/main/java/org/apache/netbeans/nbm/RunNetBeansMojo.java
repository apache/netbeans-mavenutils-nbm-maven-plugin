...
public class RunNetBeansMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        if (!clusterBuildDir.exists() || clusterBuildDir.listFiles() == null) {
            throw new MojoExecutionException("No clusters to include in execution found. "
        ...
        try {
            String[] args = new String[] {
                // TODO --jdkhome
                "--userdir", netbeansUserdir.getAbsolutePath(), "-J-Dnetbeans.logger.console=true", "-J-ea",
            };
